...
spiderman2 = media.Movie(
    ...
    "Peter Parker struggling to manage both his personal life and his " +
    "duties as Spider-Man, while Dr. Otto Octavius (Doctor Octopus) becomes" +
...
spiderman3 = media.Movie(
    "Spider-Man 3",
    "Set months after the events of Spider-Man 2, Peter Parker has become " +
    "a cultural phenomenon as Spider-Man, while Mary Jane Watson continues " +
    "her Broadway career.",
...
iron_man = media.Movie(
    "Iron Man",
    "Tony Stark, an industrialist and master engineer, builds a powered " +
...
iron_man3 = media.Movie(
    "Iron Man 3",
    "Tony Stark tries to recover from posttraumatic stress disorder caused " +
